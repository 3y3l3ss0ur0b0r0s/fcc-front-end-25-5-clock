class SpecialClock extends React.Component {
  ...
  render() {
    return (
      <div id="clockBox">
        <div className="container" id="break-box">
          ...
          <div className="row">
            ...
            <div className="lengthBox" id="break-length">
        ...
        <div className="container" id="session-box">
          ...
          <div className="row">
            ...
            <div className="lengthBox" id="session-length">
        ...
        <div className="container" id="timer-box">
          <div id="timer-label">{this.state.timerString}</div>
          <div className="timerBackground">
            <div className="row">
              <div id="time-left">
                {this.toTimeString(this.state.remainingTime)}
              </div>
              <div className="container" id="controlButtons">
                <button
